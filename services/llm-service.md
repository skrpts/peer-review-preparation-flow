...
id: llm-service
title: LLM Service
description: "Language model service providing manuscript review and publication preparation capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for manuscript review and publication preparation. Used by all skills in this skrpt.
